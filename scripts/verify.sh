...
grep -qF 'project(PlainwireDesktop VERSION 2.4.1 LANGUAGES CXX)' CMakeLists.txt \
  || fail 'CMake version is not 2.4.1'
...
printf 'Plainwire Desktop 2.4.1 source checks passed.\n'
